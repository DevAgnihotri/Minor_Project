...
class maincode:
     ...
     def cur(self):
             ...
             self.develop=Label(self.fm3,text='Developed By - Dev and Mohd. Talha',bg='#fff',fg='blue',
                               font=('Cursive',12,'italic','bold'))
             self.develop.place(x=600,y=350)

             #-----------------addbutton-----------------

             self.bt1=Button(self.fm3,text='  Add Books',fg='#fff',bg='#fc0006',font=('Arial',15,'bold'),width=170,
             ...
             self.bt2 = Button(self.fm3, text='  Issue Books', fg='#fff', bg='#fc0006', font=('Arial', 15, 'bold'),
             ...
             self.bt3 = Button(self.fm3, text='  Edit Books', fg='#fff', bg='#fc0006', font=('Arial', 15, 'bold'),
             ...
             self.bt4 = Button(self.fm3, text='  Return Books', fg='#fff', bg='#fc0006', font=('Arial', 15, 'bold'),
             ...
             self.bt5 = Button(self.fm3, text=' Delete Books', fg='#fff', bg='#fc0006', font=('Arial', 15, 'bold'),
             ...
             self.bt6 = Button(self.fm3, text='  Show Books', fg='#fff', bg='#fc0006', font=('Arial', 15, 'bold'),
             ...
             self.bt7 = Button(self.fm3, text=' Search Books', fg='#fff', bg='#fc0006', font=('Arial', 15, 'bold'),
             ...
             try:
                ...
                self.bt8 = Button(self.fm3, text='  log Out', fg='#fff', bg='#fc0006', font=('Arial', 15, 'bold'),
                               width=170,
         ...
         class temp(maincode):
             ...
             def submit1(self):
                 ...
                 try:
                    ...
                    dd.commit()
                    messagebox.showinfo('Library System', 'BOOK IS ADDED')
                    self.clear()
                 except Exception as e:
                     messagebox.showerror('Library System', f'Error occurred while adding book: {str(e)}')
         ...
         class test(maincode):
              ...
              def data(self):
                   ...
                   if self.value!=None:
                        ...
                        self.cal = Calendar(self.boot, selectmode="day", bg='black',year=self.x.year ,month=self.x.month ,day=self.x.day)
                        self.cal.place(x=20,y=380)


                        btn1 = Button(self.boot, text="Confirm Date",command=self.get_data,  bg='#fc0006',
                                      font=('arial', 10,
                                                                                                    'bold'),
                                      fg='#fff', relief='flat')
             ...
             def retbook(self):
                 ...
                 #-----------------between two date calculate days---------------------
                         ...
                         try:
                            ...
                            messagebox.showinfo('ERROR','It looks like you have given the wrong date or the student has issued no book.')
                            chm=0
                         #print(chm)
         ...
         class dele(maincode):
               ...
               def deldata(self):
                ...
                try:
                    ...
                    # Check if any rows were affected before commit
                    ...
                    messagebox.showerror('Library System', f'An error occurred: {str(e)}')
